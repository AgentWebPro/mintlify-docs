...
| Capability | Behavior |
|---|---|
| **Ad attribution** | Every booking fires a Meta conversion through your connected ad account's pixel, so Meta's reporting and optimization can credit the ad, audience, or campaign that drove it. |
...
| **Multiple accounts** | One connection per AgentWeb account. |
