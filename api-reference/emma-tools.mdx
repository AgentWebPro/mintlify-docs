...
| Endpoint | Purpose |
|---|---|
| `POST /api/emma/you-search-web` | Web search with structured results. |
| `POST /api/emma/you-search-news` | News search with structured results. |
| `POST /api/emma/google-search-web` | Web search via Google Custom Search. |
