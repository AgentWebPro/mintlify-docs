...
<Visibility for="agents">
  ...
  - **Skill manifest**: `https://api.agentweb.pro/skill.md` (for OpenClaw and any client that loads MCP servers from a skill file).
...
After connecting, paste this prompt into any session with Emma to confirm the tools are wired up correctly:
