...
| **Paid ads** | Builds, launches, and optimizes Google Ads and Meta campaigns. Reports on LinkedIn Ads. |
...
- **LinkedIn Ads is read-only.** Emma reports on LinkedIn campaigns, creatives, and targeting, but does not create or edit them. Google Ads and Meta Ads are full create-and-manage.
...
- **Emma doesn't read your inbox at large.** On Gmail she reads replies only on threads she initiated.
- **Google Drive and ClickUp are read-only.** Emma searches and reads them for context; she never writes back.
...
<Columns cols={2}>
  <Card title="Onboard your brand" icon="rocket" href="/onboarding/brand-onboarding">
    Set up brand profile, ICP personas, founder voice, and Knowledge Base first. Everything downstream depends on it.
  </Card>
  ...
  <Card title="Build your first pipeline" icon="handshake" href="/playbooks/founder-led-sales">
    The founder-led sales playbook — four stages from LinkedIn audit to meeting prep.
  </Card>
</Columns>