...
<Warning>
  **Read-only.** Emma reports on LinkedIn advertising but does not create or edit campaigns. Use Google Ads or Meta for campaigns Emma builds and runs.
</Warning>
...
- Creating, pausing, or updating any ad campaign, or changing a budget.
...
- LinkedIn Ads — reporting only, no campaign creation.
